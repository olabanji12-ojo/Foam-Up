    ...
    <>
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2 flex justify-center" uk-scrollspy="cls: uk-animation-slide-right-medium; delay: 300; repeat: true">
        ...
        <div className="container mx-auto px-6">
          <h2
            className="font-fredoka text-3xl md:text-4xl font-bold text-center text-slate-800 mb-16"
          ...
          >
            ...
            {/* Step 2 */}
            <div className="text-center p-6 bg-slate-50 rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300" uk-scrollspy="delay: 300">
            ...
            {/* Step 3 */}
            <div className="text-center p-6 bg-slate-50 rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300" uk-scrollspy="delay: 400">
              <div className="w-16 h-16 mx-auto bg-blue-100 rounded-2xl flex items-center justify-center mb-6">
